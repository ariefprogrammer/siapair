...
<div class="flex flex-col items-center py-6 mt-2">
    ...
    <span class="mt-2 text-xs px-3 py-1 rounded-full
        ...
        {{ $user->is_active ? '● Operator Aktif' : '● Nonaktif' }}
    </span>
</div>
...
<div class="grid grid-cols-2 gap-3 mb-4">
    <div class="bg-white rounded-2xl shadow-sm p-4 text-center">
        ...
        <div class="text-xs text-gray-500 mt-1">Pelanggan Ditangani</div>
    </div>
    <div class="bg-white rounded-2xl shadow-sm p-4 text-center">
        <div class="text-2xl font-bold text-green-600">{{ $totalCatatan }}</div>
        <div class="text-xs text-gray-500 mt-1">Total Catatan Meter</div>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm p-4 mb-4">
    ...
    <form method="POST" action="{{ route('operator.profile.password') }}">
        @csrf
...
<div class="bg-white rounded-2xl shadow-sm p-4 mb-6">
    ...
    <form method="POST"
          action="{{ route('operator.profile.logout') }}"
