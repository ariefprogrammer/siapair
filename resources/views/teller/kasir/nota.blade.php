...
<div class="flex justify-between items-center mb-4">
    <a href="{{ route('teller.kasir.riwayat') }}" class="text-sm color-siap mt-8 mb-6 block"><i class="fa-solid fa-angle-left text-sm mr-1"></i>Riwayat</a>
</div>
...
<div id="nota" class="bg-white rounded-xl shadow-sm p-6 font-mono text-sm">
    ...
    <div class="space-y-1 text-xs mb-4">
        ...
        <div class="flex justify-between">
            ...
            <span>{{ $pembayaran->teller->name }}</span>
        </div>
    </div>
...
<div class="mt-4 grid grid-cols-2 gap-2">
    <a href="{{ route('teller.kasir.index') }}"
       class="text-center bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 rounded-xl transition text-sm flex items-center justify-center">
       <i class="fa-solid fa-plus mr-2"></i>  
       Transaksi Baru
    </a>
    <button onclick="window.print()"
        class="text-center bg-surface border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition text-sm flex items-center justify-center">
